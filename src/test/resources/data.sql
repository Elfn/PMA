-- INSERT EMPLOYEES
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'John', 'Warton', 'warton@gmail.com','SENIOR');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Mike', 'Lanister', 'lanister@gmail.com','INTERMADIARY');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Steve', 'Reeves', 'Reeves@gmail.com','JUNIOR');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Ronald', 'Connor', 'connor@gmail.com','JUNIOR');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Jim', 'Salvator', 'Sal@gmail.com','SENIOR');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Peter', 'Henley', 'henley@gmail.com','INTERMADIARY');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Richard', 'Carson', 'carson@gmail.com','INTERMADIARY');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Honor', 'Miles', 'miles@gmail.com','JUNIOR');
insert into employee (employee_id, first_name, last_name, email,status) values (nextval('employee_seq'), 'Tony', 'Roggers', 'roggers@gmail.com','SENIOR');
